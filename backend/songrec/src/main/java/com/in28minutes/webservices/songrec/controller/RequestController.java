...
public class RequestController {
    ...
    @GetMapping("/feed")
    public List<RequestFeedItemDto> getFeed(@RequestParam(defaultValue = "0")int page,@RequestParam(defaultValue = "10")int size){
        return requestFeedService.getFeed(page,size);
    }

    @GetMapping("/me")
    public List<RequestSummaryResponseDto> getMyRequests(@AuthenticationPrincipal JwtPrincipal principal) {
    ...
    public ResponseEntity<RecommendedTracksResponseDto> addRecommendedTracksToRequest(
        ...
        tracks.forEach(track -> requestTrackService.addTrackByRequest(principal.userId(), requestId,track.getId()));
    ...
    public ResponseEntity<RequestTrackRatingResponseDto> rateRequestTrackRating(
        ...
        RequestTrack rt = ratingApplicationService.rateTrack(principal.userId(), requestId,trackId, ratingDto.getRating());
    ...
    public ResponseEntity<RequestKeywordResponseDto> addKeywordByRequest(
        ...
        RequestKeyword rk=  requestKeywordService.addKeywordByRequest(principal.userId(), requestId,keywordId);
